...
# Melbourne
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(mel_loc)).get_items()):
    if i>max_tweets:
        break
...
mel_depression_df.to_csv('Melbourne 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(mel_loc)).get_items()):
    if i>max_tweets:
        break
...
mel_anxiety_df.to_csv('Melbourne 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(mel_loc)).get_items()):
    if i>max_tweets:
        break
...
mel_suicide_df.to_csv('Melbourne 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(mel_loc)).get_items()):
    if i>max_tweets:
        break
...
mel_mental_health_df.to_csv('Melbourne 20-21 (mental_health).csv', sep=',', index=False)

mel_dfs = pd.concat([mel_depression_df, mel_anxiety_df, mel_suicide_df, mel_mental_health_df])
mel_dfs.to_csv('Melbourne MHP 20-21 (Combined).csv', sep=',', index=False)

# Sydney
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(syd_loc)).get_items()):
    if i>max_tweets:
        break
...
syd_depression_df.to_csv('Sydney 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(syd_loc)).get_items()):
    if i>max_tweets:
        break
...
syd_anxiety_df.to_csv('Sydney 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(syd_loc)).get_items()):
    if i>max_tweets:
        break
...
syd_suicide_df.to_csv('Sydney 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(syd_loc)).get_items()):
    if i>max_tweets:
        break
...
syd_mental_health_df.to_csv('Sydney 20-21 (mental_health).csv', sep=',', index=False)

syd_dfs = pd.concat([syd_depression_df, syd_anxiety_df, syd_suicide_df, syd_mental_health_df])
syd_dfs.to_csv('Sydney MHP 20-21 (Combined).csv', sep=',', index=False)

# Brisbane
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bri_loc)).get_items()):
    if i>max_tweets:
        break
...
bri_depression_df.to_csv('Brisbane 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bri_loc)).get_items()):
    if i>max_tweets:
        break
...
bri_anxiety_df.to_csv('Brisbane 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bri_loc)).get_items()):
    if i>max_tweets:
        break
...
bri_suicide_df.to_csv('Brisbane 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bri_loc)).get_items()):
    if i>max_tweets:
        break
...
bri_mental_health_df.to_csv('Brisbane 20-21 (mental_health).csv', sep=',', index=False)

bri_dfs = pd.concat([bri_depression_df, bri_anxiety_df, bri_suicide_df, bri_mental_health_df])
bri_dfs.to_csv('Brisbane MHP 20-21 (Combined).csv', sep=',', index=False)

# Perth
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(per_loc)).get_items()):
    if i>max_tweets:
        break
...
per_depression_df.to_csv('Perth 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(per_loc)).get_items()):
    if i>max_tweets:
        break
...
per_anxiety_df.to_csv('Perth 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(per_loc)).get_items()):
    if i>max_tweets:
        break
...
per_suicide_df.to_csv('Perth 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(per_loc)).get_items()):
    if i>max_tweets:
        break
...
per_mental_health_df.to_csv('Perth 20-21 (mental_health).csv', sep=',', index=False)

per_dfs = pd.concat([per_depression_df, per_anxiety_df, per_suicide_df, per_mental_health_df])
per_dfs.to_csv('Perth MHP 20-21 (Combined).csv', sep=',', index=False)

# Adelaide
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ade_loc)).get_items()):
    if i>max_tweets:
        break
...
ade_depression_df.to_csv('Adelaide 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ade_loc)).get_items()):
    if i>max_tweets:
        break
...
ade_anxiety_df.to_csv('Adelaide 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ade_loc)).get_items()):
    if i>max_tweets:
        break
...
ade_suicide_df.to_csv('Adelaide 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ade_loc)).get_items()):
    if i>max_tweets:
        break
...
ade_mental_health_df.to_csv('Adelaide 20-21 (mental_health).csv', sep=',', index=False)

ade_dfs = pd.concat([ade_depression_df, ade_anxiety_df, ade_suicide_df, ade_mental_health_df])
ade_dfs.to_csv('Adelaide MHP 20-21 (Combined).csv', sep=',', index=False)

# Gold Coast
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(golcoa_loc)).get_items()):
    if i>max_tweets:
        break
...
golcoa_depression_df.to_csv('Gold Coast 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(golcoa_loc)).get_items()):
    if i>max_tweets:
        break
...
golcoa_anxiety_df.to_csv('Gold Coast 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(golcoa_loc)).get_items()):
    if i>max_tweets:
        break
...
golcoa_suicide_df.to_csv('Gold Coast 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(golcoa_loc)).get_items()):
    if i>max_tweets:
        break
...
golcoa_mental_health_df.to_csv('Gold Coast 20-21 (mental_health).csv', sep=',', index=False)

golcoa_dfs = pd.concat([golcoa_depression_df, golcoa_anxiety_df, golcoa_suicide_df, golcoa_mental_health_df])
golcoa_dfs.to_csv('Gold Coast MHP 20-21 (Combined).csv', sep=',', index=False)

# Newcastle
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(new_loc)).get_items()):
    if i>max_tweets:
        break
...
new_depression_df.to_csv('Newcastle 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(new_loc)).get_items()):
    if i>max_tweets:
        break
...
new_anxiety_df.to_csv('Newcastle 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(new_loc)).get_items()):
    if i>max_tweets:
        break
...
new_suicide_df.to_csv('Newcastle 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(new_loc)).get_items()):
    if i>max_tweets:
        break
...
new_mental_health_df.to_csv('Newcastle 20-21 (mental_health).csv', sep=',', index=False)

new_dfs = pd.concat([new_depression_df, new_anxiety_df, new_suicide_df, new_mental_health_df])
new_dfs.to_csv('Newcastle MHP 20-21 (Combined).csv', sep=',', index=False)

# Canberra
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(can_loc)).get_items()):
    if i>max_tweets:
        break
...
can_depression_df.to_csv('Canberra 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(can_loc)).get_items()):
    if i>max_tweets:
        break
...
can_anxiety_df.to_csv('Canberra 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(can_loc)).get_items()):
    if i>max_tweets:
        break
...
can_suicide_df.to_csv('Canberra 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(can_loc)).get_items()):
    if i>max_tweets:
        break
...
can_mental_health_df.to_csv('Canberra 20-21 (mental_health).csv', sep=',', index=False)

can_dfs = pd.concat([can_depression_df, can_anxiety_df, can_suicide_df, can_mental_health_df])
can_dfs.to_csv('Canberra MHP 20-21 (Combined).csv', sep=',', index=False)

# Sunshine Coast
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(suncoa_loc)).get_items()):
    if i>max_tweets:
        break
...
suncoa_depression_df.to_csv('Sunshine Coast 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(suncoa_loc)).get_items()):
    if i>max_tweets:
        break
...
suncoa_anxiety_df.to_csv('Sunshine Coast 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(suncoa_loc)).get_items()):
    if i>max_tweets:
        break
...
suncoa_suicide_df.to_csv('Sunshine Coast 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(suncoa_loc)).get_items()):
    if i>max_tweets:
        break
...
suncoa_mental_health_df.to_csv('Sunshine Coast 20-21 (mental_health).csv', sep=',', index=False)

suncoa_dfs = pd.concat([suncoa_depression_df, suncoa_anxiety_df, suncoa_suicide_df, suncoa_mental_health_df])
suncoa_dfs.to_csv('Sunshine Coast MHP 20-21 (Combined).csv', sep=',', index=False)

# Central Coast
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cencoa_loc)).get_items()):
    if i>max_tweets:
        break
...
cencoa_depression_df.to_csv('Central Coast 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cencoa_loc)).get_items()):
    if i>max_tweets:
        break
...
cencoa_anxiety_df.to_csv('Central Coast 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cencoa_loc)).get_items()):
    if i>max_tweets:
        break
...
cencoa_suicide_df.to_csv('Central Coast 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cencoa_loc)).get_items()):
    if i>max_tweets:
        break
...
cencoa_mental_health_df.to_csv('Central Coast 20-21 (mental_health).csv', sep=',', index=False)

cencoa_dfs = pd.concat([cencoa_depression_df, cencoa_anxiety_df, cencoa_suicide_df, cencoa_mental_health_df])
cencoa_dfs.to_csv('Central Coast MHP 20-21 (Combined).csv', sep=',', index=False)

# Wollongong
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(wol_loc)).get_items()):
    if i>max_tweets:
        break
...
wol_depression_df.to_csv('Wollongong 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(wol_loc)).get_items()):
    if i>max_tweets:
        break
...
wol_anxiety_df.to_csv('Wollongong 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(wol_loc)).get_items()):
    if i>max_tweets:
        break
...
wol_suicide_df.to_csv('Wollongong 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(wol_loc)).get_items()):
    if i>max_tweets:
        break
...
wol_mental_health_df.to_csv('Wollongong 20-21 (mental_health).csv', sep=',', index=False)

wol_dfs = pd.concat([wol_depression_df, wol_anxiety_df, wol_suicide_df, wol_mental_health_df])
wol_dfs.to_csv('Wollongong MHP 20-21 (Combined).csv', sep=',', index=False)

# Geelong
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(gee_loc)).get_items()):
    if i>max_tweets:
        break
...
gee_depression_df.to_csv('Geelong 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(gee_loc)).get_items()):
    if i>max_tweets:
        break
...
gee_anxiety_df.to_csv('Geelong 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(gee_loc)).get_items()):
    if i>max_tweets:
        break
...
gee_suicide_df.to_csv('Geelong 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(gee_loc)).get_items()):
    if i>max_tweets:
        break
...
gee_mental_health_df.to_csv('Geelong 20-21 (mental_health).csv', sep=',', index=False)

gee_dfs = pd.concat([gee_depression_df, gee_anxiety_df, gee_suicide_df, gee_mental_health_df])
gee_dfs.to_csv('Geelong MHP 20-21 (Combined).csv', sep=',', index=False)

# Hobart
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(hob_loc)).get_items()):
    if i>max_tweets:
        break
...
hob_depression_df.to_csv('Hobart 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(hob_loc)).get_items()):
    if i>max_tweets:
        break
...
hob_anxiety_df.to_csv('Hobart 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(hob_loc)).get_items()):
    if i>max_tweets:
        break
...
hob_suicide_df.to_csv('Hobart 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(hob_loc)).get_items()):
    if i>max_tweets:
        break
...
hob_mental_health_df.to_csv('Hobart 20-21 (mental_health).csv', sep=',', index=False)

hob_dfs = pd.concat([hob_depression_df, hob_anxiety_df, hob_suicide_df, hob_mental_health_df])
hob_dfs.to_csv('Hobart MHP 20-21 (Combined).csv', sep=',', index=False)

# Townsville
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(tow_loc)).get_items()):
    if i>max_tweets:
        break
...
tow_depression_df.to_csv('Townsville 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(tow_loc)).get_items()):
    if i>max_tweets:
        break
...
tow_anxiety_df.to_csv('Townsville 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(tow_loc)).get_items()):
    if i>max_tweets:
        break
...
tow_suicide_df.to_csv('Townsville 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(tow_loc)).get_items()):
    if i>max_tweets:
        break
...
tow_mental_health_df.to_csv('Townsville 20-21 (mental_health).csv', sep=',', index=False)

tow_dfs = pd.concat([tow_depression_df, tow_anxiety_df, tow_suicide_df, tow_mental_health_df])
tow_dfs.to_csv('Townsville MHP 20-21 (Combined).csv', sep=',', index=False)

# Cairns
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cai_loc)).get_items()):
    if i>max_tweets:
        break
...
cai_depression_df.to_csv('Cairns 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cai_loc)).get_items()):
    if i>max_tweets:
        break
...
cai_anxiety_df.to_csv('Cairns 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cai_loc)).get_items()):
    if i>max_tweets:
        break
...
cai_suicide_df.to_csv('Cairns 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(cai_loc)).get_items()):
    if i>max_tweets:
        break
...
cai_mental_health_df.to_csv('Cairns 20-21 (mental_health).csv', sep=',', index=False)

cai_dfs = pd.concat([cai_depression_df, cai_anxiety_df, cai_suicide_df, cai_mental_health_df])
cai_dfs.to_csv('Cairns MHP 20-21 (Combined).csv', sep=',', index=False)

# Toowoomba
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(too_loc)).get_items()):
    if i>max_tweets:
        break
...
too_depression_df.to_csv('Toowoomba 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(too_loc)).get_items()):
    if i>max_tweets:
        break
...
too_anxiety_df.to_csv('Toowoomba 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(too_loc)).get_items()):
    if i>max_tweets:
        break
...
too_suicide_df.to_csv('Toowoomba 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(too_loc)).get_items()):
    if i>max_tweets:
        break
...
too_mental_health_df.to_csv('Toowoomba 20-21 (mental_health).csv', sep=',', index=False)

too_dfs = pd.concat([too_depression_df, too_anxiety_df, too_suicide_df, too_mental_health_df])
too_dfs.to_csv('Toowoomba MHP 20-21 (Combined).csv', sep=',', index=False)

# Darwin
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(dar_loc)).get_items()):
    if i>max_tweets:
        break
...
dar_depression_df.to_csv('Darwin 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(dar_loc)).get_items()):
    if i>max_tweets:
        break
...
dar_anxiety_df.to_csv('Darwin 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(dar_loc)).get_items()):
    if i>max_tweets:
        break
...
dar_suicide_df.to_csv('Darwin 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(dar_loc)).get_items()):
    if i>max_tweets:
        break
...
dar_mental_health_df.to_csv('Darwin 20-21 (mental_health).csv', sep=',', index=False)

dar_dfs = pd.concat([dar_depression_df, dar_anxiety_df, dar_suicide_df, dar_mental_health_df])
dar_dfs.to_csv('Darwin MHP 20-21 (Combined).csv', sep=',', index=False)

# Ballarat
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bal_loc)).get_items()):
    if i>max_tweets:
        break
...
bal_depression_df.to_csv('Ballarat 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bal_loc)).get_items()):
    if i>max_tweets:
        break
...
bal_anxiety_df.to_csv('Ballarat 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bal_loc)).get_items()):
    if i>max_tweets:
        break
...
bal_suicide_df.to_csv('Ballarat 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(bal_loc)).get_items()):
    if i>max_tweets:
        break
...
bal_mental_health_df.to_csv('Ballarat 20-21 (mental_health).csv', sep=',', index=False)

bal_dfs = pd.concat([bal_depression_df, bal_anxiety_df, bal_suicide_df, bal_mental_health_df])
bal_dfs.to_csv('Ballarat MHP 20-21 (Combined).csv', sep=',', index=False)

# Bendigo
# depression
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('depression since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ben_loc)).get_items()):
    if i>max_tweets:
        break
...
ben_depression_df.to_csv('Bendigo 20-21 (depression).csv', sep=',', index=False)

# anxiety
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('anxiety since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ben_loc)).get_items()):
    if i>max_tweets:
        break
...
ben_anxiety_df.to_csv('Bendigo 20-21 (anxiety).csv', sep=',', index=False)

# suicide
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('suicide since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ben_loc)).get_items()):
    if i>max_tweets:
        break
...
ben_suicide_df.to_csv('Bendigo 20-21 (suicide).csv', sep=',', index=False)

# mental-health
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('mental-health since:2020-03-11 until:2021-03-11 geocode:"{}"'.format(ben_loc)).get_items()):
    if i>max_tweets:
        break
...
ben_mental_health_df.to_csv('Bendigo 20-21 (mental_health).csv', sep=',', index=False)

ben_dfs = pd.concat([ben_depression_df, ben_anxiety_df, ben_suicide_df, ben_mental_health_df])
ben_dfs.to_csv('Bendigo MHP 20-21 (Combined).csv', sep=',', index=False)




mhp_2020_2021_dfs = pd.concat([mel_dfs, syd_dfs, bri_dfs, per_dfs, ade_dfs, golcoa_dfs, new_dfs, can_dfs, suncoa_dfs, cencoa_dfs, wol_dfs, gee_dfs, hob_dfs, tow_dfs, cai_dfs, too_dfs, dar_dfs, bal_dfs, ben_dfs])
mhp_2020_2021_dfs.sort_values(by=['City', 'Datetime', 'Tweet Id', 'Username', 'Text'], inplace=True, ascending=True)
mhp_2020_2021_dfs.drop_duplicates(subset='Text', keep=False, inplace=True)
mhp_2020_2021_dfs.to_csv('MHP 2020-2021.csv', sep=',', index=False)